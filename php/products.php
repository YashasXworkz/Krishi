    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <div class="navbar-collapse collapse">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#"> <img src="https://img.icons8.com/metro/26/ffffff/user-male.png">
          ...
          <tbody>
            ...
            <tr>
              <form method="POST" action="insert.php">
                ...
                <td>
                  <div class="input-container"><input type="text" name="qty" required></div>
                </td>
                <td>
                  <div class="input-container"><input type="text" name="price" required></div>
                </td>
                <td width="20%"><button type="submit" class="btn btn-success" name="add" value="add">Add to
                    Shop</button></td>
              </form>
            </tr>
            <?php
